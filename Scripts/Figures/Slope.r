...
points(subset(dataDVSI, LAI==3 & h3==1 & d<=10, select=c("P50", "slope")), type="l", col=Cols[1], lty=1)
points(subset(dataDVSI, LAI==3 & h3==100 & d<=10, select=c("P50", "slope")), type="l", col=Cols[1], lty=2)
segments(subset(dataDVSI, LAI==3 & h3==100, select=c("P50"))[[1]][1], 0,
